...
<head>
    ...
    <style>
        ...
        /* FIXED TABLE STYLES - WIDER TABLE */
        .data-table {
            width: 100%;
            border-collapse: collapse;
            font-size: 0.875rem;
            table-layout: fixed; /* Changed to fixed for consistent column widths */
        }
        .data-table th {
        ...
        .data-table td:nth-child(3) {
            width: 300px; /* Address column - wider */
        }
        .data-table th:nth-child(4),
        .data-table td:nth-child(4) {
            width: 120px; /* Control No. column */
        }
        .data-table th:nth-child(5),
        .data-table td:nth-child(5) {
            width: 80px; /* Cert Count column */
        }
        ...
        .data-table td:nth-child(7) {
            width: 120px; /* Date Issued column */
        }
        ...
        /* FIXED TABLE CONTAINER - FULL WIDTH */
        .table-container {
            width: 100%;
            overflow-x: auto;
        ...
        .main-content-container {
            width: auto;
            max-width: none;
            padding: 1rem 1rem; /* Reduced padding to give more space for table */
        }
        .action-btn {
            display: inline-flex;
            align-items: center;
        ...
        @media (max-width: 768px) {
            ...
            /* On mobile, revert to auto layout */
            .data-table {
                table-layout: auto;
            }
